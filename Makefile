...
COMPRESS      = gzip -9f
DISTNAME      = GUI1.0.0
DISTDIR = /home/Michal/Desktop/Sieci/MailboX/.tmp/GUI1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1
...
clean: compiler_clean 
	-$(DEL_FILE) $(OBJECTS)
	-$(DEL_FILE) *~ core *.core GUI.out server.out
...
SERVER_SOURCES = Database.cpp server.cpp
SERVER_CXXFLAGS = -Wall -lsqlite3

$(SERVER_TARGET): $(SERVER_SOURCES)
	$(CXX) $(SERVER_SOURCES) -o $(SERVER_TARGET) $(SERVER_CXXFLAGS)
